## 1 - OSSIFICATION AND 2 - SIZE ALLOMETRY EAR BONES IN ONTOGENY ##
# Tympanic bulla and periotic
...
stages <- data.frame(Age_months = c(2, 12/2), Age_100 = c(20,50)) 
#embryo fixed to about 2 months (see Roston et al. 2013, The Anatomical Record 296, 709-722), 
#early fetus from embryo to 50% gestation
...
#ANOVA tables - difference between models
...
#AICc score - best model selection
