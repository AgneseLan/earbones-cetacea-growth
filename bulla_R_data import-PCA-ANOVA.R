...
image(1:3, 1, as.matrix(1:3), col = mypalette_category, xlab = "categories colors - early, late, postnatal", ylab = "", yaxt = "n")
...
##Regression PC1 and PC2 vs size (bulla log length), group, category ----
...
#Save results of significant regression to file
sink("bulla_R/PC1-PC2_category_lm.txt")
print("PC1")
summary(reg_PC1all_category)
...
#Save results of significant regression to file
sink("bulla_R/allometry_taxa_shape.txt")
summary(allometry_taxa)
sink() 
...
allometry_taxa_ggplot_taxon <- ggplot(allometry_plot_taxa, aes(x = size, y = RegScores, colour = taxon, shape = group))+
  ...
  scale_color_manual(name = "Taxa", labels  = c("B.bonaerensis", "B.physalus", "Ph.phocoena", "St.attenuata"), values = mypalette_taxa, #select colors from palette from taxa
...
##Regression Axis1 and Axis2 vs size (bulla log length), group, category ----
#Check if size an important factor in results overall
#Create data frame with data
...
#Save results of significant regression to file
sink("bulla_R/axis1-axis2_group_lm.txt")
print("I")
summary(reg_axis1_group)
...
#Save results of significant regression to file
sink("bulla_R/axis1-axis2_category_lm.txt")
print("I")
summary(reg_axis1_category)
...
#Save results to file
sink("bulla_R/pairwise_allometry_pcscores_taxa.txt")
print("ANOVA models")
anova(allometry_pcscores_taxa,allometry_pcscores_taxa_comb,allometry_pcscores_taxa_int)
...
#Save results to file
sink("bulla_R/allometry_taxa_early_group.txt")
print("No group")
summary(allometry_pcscores_taxa_early)
...
#Save results to file
sink("bulla_R/pairwise_allometry_pcscores_taxa_early_group.txt")
print("ANOVA models")
anova(allometry_pcscores_taxa_early,allometry_pcscores_taxa_early_group_comb,allometry_pcscores_taxa_early_group_int)
...
#Save results to file
sink("bulla_R/allometry_taxa_late_group.txt")
print("No group")
summary(allometry_pcscores_taxa_late)
...
#Save results to file
sink("bulla_R/pairwise_allometry_pcscores_taxa_late_group.txt")
print("ANOVA models")
anova(allometry_pcscores_taxa_late,allometry_pcscores_taxa_late_group_comb,allometry_pcscores_taxa_late_group_int)
