...
sink("periotic_R/PC1-PC2_res_group_lm.txt")
print("PC1")
summary(reg_PC1res_group)
...
#Save results of significant regression to file
sink("periotic_R/PC1-PC2_res_category_lm.txt")
print("PC1")
summary(reg_PC1res_category)
...
sink("periotic_R/category_disparity.txt")
...
#Save results to file
sink("periotic_R/category_group_disparity.txt")
...
#Save results to file
sink("periotic_R/category_taxa_disparity.txt")
...
#Save results to file
sink("periotic_R/group_disparity_early.txt")
summary(group_disparity_early)
sink() 
...
#Save results to file
sink("periotic_R/group_disparity_latefetus.txt")
summary(group_disparity_late)
sink() 
